...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Handle commands and update game state
        }
    }
    ...
    private static void printWelcomeMessage() {
        ...
        // CommandParser.printHelpMessage(); // Assuming CommandParser is implemented
    }
    ...
    private static void generateRoomsFromFile() {
        ...
        state = new GameState(worldModel.get("start"), new Enemy[0]); // Assumes a start room exists
    }
}